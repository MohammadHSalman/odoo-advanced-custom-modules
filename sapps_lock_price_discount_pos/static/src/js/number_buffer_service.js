...
import {GlobalDiscountPopupWidget} from "@sapps_lock_price_discount_pos/js/global_discount_popup";
...
export const customNumberBufferService = {
    dependencies: NumberBuffer.serviceDependencies,
    start(env, deps) {
        return new NumberBuffer(deps);
    },
};
registry.category("services").remove("number_buffer");
registry.category("services").add("number_buffer", customNumberBufferService);